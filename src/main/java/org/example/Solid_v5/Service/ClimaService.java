package org.example.Solid_v5.Service;

import org.example.Solid_v5.HttpClientConfig.Client;
...
public class ClimaService {
    ...
    public String exibeInfoClima(String apiUrl) throws IOException, InterruptedException {
        ...
        Client httpClient = new Client(client);

        String responseJson = httpClient.disparaGet(apiUrl);
